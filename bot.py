...
async def check_membership_callback(client, callback_query):
    ...
    if not_joined:
        ...
        try:
            ...
            # ارسال پیام تشکر جذاب
            caption_text = (
                "<b>🌟 ممنون که عضو شدی!</b>\n\n"
                "🎉 از انتخابت سپاسگزاریم.\n"
                "✨ به جمع ما خوش آمدی! امیدواریم از ربات نهایت استفاده رو ببری. ❤️\n\n"
                "<i>برای دریافت آخرین فیلم‌ها و سریال‌ها ما رو دنبال کن!</i>"
            )

            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("📺 کانال ما", url="https://t.me/BoxOfficeMoviiie")],
                [InlineKeyboardButton("🔄 بازگشت به ربات", callback_data="start")]
            ])
            ...
            # اگر خطا رخ داد، پیام متنی جایگزین بده
